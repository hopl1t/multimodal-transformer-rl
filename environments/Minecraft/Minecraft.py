...
class Minecraft():
    ...
    def _init_render(self):
        ...
        if self.simple_render:
            ...
            self.img_agent      = self._read_img('environments/Minecraft/TexturePacker/All/Characters/Player_Male/male.png', interp = cv2.INTER_NEAREST)
            self.img_stone      = self._read_img('environments/Minecraft/TexturePacker/All/Tiles/stone.png')
            self.img_pick_gold  = self._read_img('environments/Minecraft/TexturePacker/All/Items/pick_gold.png', interp = cv2.INTER_NEAREST)
            self.img_pick_iron  = self._read_img('environments/Minecraft/TexturePacker/All/Items/shovel_bronze.png', interp = cv2.INTER_NEAREST)
