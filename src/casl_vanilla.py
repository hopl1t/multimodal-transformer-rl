...
if __name__ == "__main__":
    ...
    if args.audio_ratio:
        ...
        agent = MinecraftAgent(envs, device, args.conv_type, attn_type='casl', fusion_type=args.fusion_type, init_bias=args.init_bias, init_weights=args.init_weights, min_audio_attn=args.min_audio_attn, max_audio_attn=args.max_audio_attn).to(device)
    ...
    for update in range(1, num_updates + 1):
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.num_envs, envsperbatch):
                ...
                _, newlogprob, entropy, newvalue, _, attn_weights = agent.get_action_and_value(
                    b_obs[mb_inds],
        ...
        writer.add_scalar("charts/avg_video_attn", attn_weights[:,0].mean(), global_step)
        writer.add_scalar("charts/avg_audio_attn", attn_weights[:,1].mean(), global_step)
