...
if __name__ == "__main__":
    ...
    if args.audio_ratio:
        ...
        agent = MinecraftAgent(envs, device, args.conv_type, attn_type='casl', fusion_type=args.fusion_type, init_bias=args.init_bias, min_audio_attn=args.min_audio_attn, max_audio_attn=args.max_audio_attn).to(device)
