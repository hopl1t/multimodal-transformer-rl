...
class Doorpuzzle():
    ...
    # AUDIO-RELATED
    def _init_mfcc(self):
        self.mfcc_target1   = self._get_mfcc('environment/Doorpuzzle/assets/target_good.wav')
        self.mfcc_target2   = self._get_mfcc('environment/Doorpuzzle/assets/target_bad.wav')
        self.mfcc_no_listen = self._get_mfcc('environment/Doorpuzzle/assets/noise.wav')
