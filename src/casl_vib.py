...
if __name__ == "__main__":
    ...
    print(f"### USING MINECRAFT CASL AGENT, BETA: {args.ib_beta} ###")
    agent = VIBAgent(envs, device, conv_type=args.conv_type, use_attn=args.use_attention, fusion_type=args.fusion_type, dropout_ratio=args.dropout_ratio).to(device)
    ...
    for update in range(1, num_updates + 1):
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.num_envs, envsperbatch):
                ...
                _, newlogprob, entropy, newvalue, _, (mu, std) = agent.get_action_and_value(
                    b_obs[mb_inds],
                ...
                loss = pg_loss - args.ent_coef * entropy_loss + v_loss * args.vf_coef - info_loss
        ...
        writer.add_scalar("charts/kl", kl, global_step)
        ...
        writer.add_scalar("losses/info_loss", info_loss, global_step)
